 ...
 *
 * Proxies the three Volcengine ASR products exposed in the current console:
 * streaming, recording-file 1.0, and recording-file 2.0. Credentials are
 * passed to one child process through its temporary environment and are never
